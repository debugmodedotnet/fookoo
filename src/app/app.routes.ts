...
import { checkIfEmailVerifiedGuard } from './services/check-if-email-verified.guard';

export const routes: Routes = [
  {
    path: 'verify-email',
    loadComponent: () => import('./verify-email-prompt/verify-email-prompt.component').then(m => m.VerifyEmailPromptComponent)
  },
  {
    path: '',
    canActivateChild: [checkIfEmailVerifiedGuard],
    children: [
